<?php
  ...
  $st=mysqli_query($conn,"SELECT * FROM customer WHERE u_id =".$_SESSION['user']);
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="add_product.php"><i class="fa fa-edit"></i> Add  Product Details  <span class="fa fa-chevron-down"></span></a>
                  </li>
